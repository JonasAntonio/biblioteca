...
<body>";
    ...
    public static function sidebar()
    {
        ...
        <div class=\"sidebar-wrapper\">
            ...
            <ul class=\"nav\">
                <li class=\""; echo $_SESSION['active_window'] == 'autores' ? 'active' : 'deactive' ;echo"\">
                    <a href='autores.php'>
                        <i class=\"ti-user\"></i>
                        <p>Autores</p>
                    </a>
                </li>
                <li class=\""; echo $_SESSION['active_window'] == 'editoras' ? 'active' : 'deactive'; echo"\">
                    <a href = 'editoras.php' >
                        <i class=\"ti-book\"></i >
                        <p > Editoras</p >
                    </a >
                </li >
                <li class=\""; echo $_SESSION['active_window'] == 'categorias' ? 'active' : 'deactive'; echo"\">
                    <a href = 'categorias.php' >
                        <i class=\"ti-book\"></i >
                        <p > Categorias</p >
                    </a >
                </li >
                <li class=\"";echo $_SESSION['active_window'] == 'livros' ? 'active' : 'deactive';echo"\">
                    <a href='livros.php'>
                        <i class=\"ti-book\"></i>
                        <p>Livros</p>
                    </a>
