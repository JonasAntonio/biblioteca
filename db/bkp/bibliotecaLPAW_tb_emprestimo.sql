...
CREATE TABLE `tb_emprestimo` (
  ...
  CONSTRAINT `fk_tb_usuario_has_tb_exemplar_tb_exemplar1` FOREIGN KEY (`tb_exemplar_id_tb_exemplar`) REFERENCES `tb_exemplar` (`idtb_exemplar`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_usuario_has_tb_exemplar_tb_usuario1` FOREIGN KEY (`tb_usuario_id_tb_usuario`) REFERENCES `tb_usuario` (`idtb_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2019-05-21 20:59:33
