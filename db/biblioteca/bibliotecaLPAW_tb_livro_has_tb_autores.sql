...
CREATE TABLE `tb_livro_has_tb_autores` (
  ...
  PRIMARY KEY (`tb_livro_id_tb_livro`,`tb_autores_id_tb_autores`),
  ...
  CONSTRAINT `fk_tb_livro_has_tb_autores_tb_autores1` FOREIGN KEY (`tb_autores_id_tb_autores`) REFERENCES `tb_autores` (`id_tb_autores`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_livro_has_tb_autores_tb_livro` FOREIGN KEY (`tb_livro_id_tb_livro`) REFERENCES `tb_livro` (`id_tb_livro`) ON DELETE NO ACTION ON UPDATE NO ACTION
