...
CREATE TABLE `tb_livro` (
  `id_tb_livro` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_tb_livro_tb_categoria1` FOREIGN KEY (`tb_categoria_id_tb_categoria`) REFERENCES `tb_categoria` (`id_tb_categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_livro_tb_editora1` FOREIGN KEY (`tb_editora_id_tb_editora`) REFERENCES `tb_editora` (`id_tb_editora`) ON DELETE NO ACTION ON UPDATE NO ACTION
