...
CREATE TABLE `tb_exemplar` (
  `id_tb_exemplar` int(11) NOT NULL AUTO_INCREMENT,
  `tipoExemplar` int(11) NOT NULL,
  `tb_livro_id_tb_livro` int(11) NOT NULL,
  PRIMARY KEY (`id_tb_exemplar`),
  KEY `fk_tb_exemplar_tb_livro1_idx` (`tb_livro_id_tb_livro`),
  CONSTRAINT `fk_tb_exemplar_tb_livro1` FOREIGN KEY (`tb_livro_id_tb_livro`) REFERENCES `tb_livro` (`id_tb_livro`) ON DELETE NO ACTION ON UPDATE NO ACTION
